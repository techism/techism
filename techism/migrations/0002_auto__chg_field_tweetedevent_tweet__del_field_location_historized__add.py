...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TweetedEvent.tweet'
        db.alter_column('techism_tweetedevent', 'tweet', self.gf('django.db.models.fields.CharField')(max_length=500))
        # Deleting field 'Location.historized'
        db.delete_column('techism_location', 'historized')

        # Adding field 'Location.historized_since'
        db.add_column('techism_location', 'historized_since',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TweetedEvent.tweet'
        db.alter_column('techism_tweetedevent', 'tweet', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Adding field 'Location.historized'
        db.add_column('techism_location', 'historized',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Location.historized_since'
        db.delete_column('techism_location', 'historized_since')
